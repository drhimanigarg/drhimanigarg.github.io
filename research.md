...
Matrix (lattice-structured) cooling channels are a promising alternative to conventional rib-turbulated cooling passages in turbine blades. Together with KTH and industrial partners, we investigate turbulent heat transfer and pressure loss in these geometries using both LES and RANS, aiming at design rules for the next generation of efficient, durable turbine cooling.
